...
export function ModulesSidebar() {
  ...
  return (
    <aside
      ...
      className="h-full min-h-[calc(100vh-170px)] w-[460px] shrink-0 space-y-4 overflow-y-auto border border-yellow-400/30 bg-gradient-to-b from-mist-950 to-mist-900 p-4 text-yellow-50 shadow-lg scrollbar-thin dark:bg-none dark:bg-mist-300 dark:border-mist-300 dark:text-mist-900"
    >
