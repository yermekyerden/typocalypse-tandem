...
export function LibraryTerminalSection() {
  ...
  return (
    <section
      ...
      className="flex min-h-[360px] flex-col overflow-hidden rounded-xl border border-yellow-400/25 bg-gradient-to-b from-mist-950 to-mist-900 p-4 shadow-lg sm:min-h-[420px] sm:p-5 lg:min-h-0 lg:flex-1"
    >
