  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-4 backdrop-blur-sm">
      <div
        role="dialog"
        aria-modal="true"
        aria-labelledby="library-completion-title"
        aria-describedby="library-completion-description"
      ...
      >
        <div className="space-y-2 text-center">
          ...
          <p
            id="library-completion-description"
            className="text-sm leading-relaxed text-amber-100/80"
          >
